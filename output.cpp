...
#include <time.h>   // For time(), gmtime(), localtime(), asctime(), time_t, struct tm, time, mktime()
...
static std::string endHTML = "<br><br><br><p style=\"text-align: right;\">Report generated by Storing Devices identifiers gathering tool developed by Jose Miguel Sánchez Almagro, as part of Storing devices information gathering Master's thesis.</p></body></html>";
